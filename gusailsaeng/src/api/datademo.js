    ...
    item: [
      {
        ...
        HOMEPAGE_URL: "http://www.ydculture.com/huinnyeoulculturetown/",
        TRFC_INFO:
        ...
        USAGE_AMOUNT: "무료",
        MIDDLE_SIZE_RM1:
          "점보버스 휠체어 리프트 장착 차량 운행, 요금 할인 50%, 장애인 주차장(절영해안산책로 공영주차장, 유료)",
        MAIN_IMG_NORMAL:
          "https://www.visitbusan.net/uploadImgs/files/cntnts/20191222164810529_ttiel",
        MAIN_IMG_THUMB:
      ...
      },
      {
        ...
        LNG: 129.03255,
        PLACE: "깡깡이 예술마을",
        TITLE: "역사가 살아 숨 쉬는 깡깡이예술마을",
        SUBTITLE: "역사와 예술이 공존하는 곳",
        ADDR1: "부산시 영도구 대평북로 36 깡깡이 안내센터",
        CNTCT_TEL: "051-418-3336",
        HOMEPAGE_URL: "http://kangkangee.com",
        TRFC_INFO:
          "도시철도 1호선 남포역 (6번출구) 도보 18분 \n마을버스 영도구2 대평동 하차 \n주차 봉래동, 남항시장 공영주차장 (유료)",
        USAGE_DAY: "",
        HLDY_INFO: "매주 월요일 (투어 등 시설)",
        USAGE_DAY_WEEK_AND_TIME:
          "평일, 주말 10:00~17:00\n가급적 평일 낮 시간 제외, 주말 혹은 통합투어 프로그램 이용 요망",
        USAGE_AMOUNT: "프로그램별 상이 ",
      ...
      },
      {
        ...
        LNG: 129.17046,
        PLACE: "아홉산 숲",
        TITLE: "400년간 지켜온 자연 그대로의 숲을 만나다",
        SUBTITLE: "대나무의 집, 기장 아홉산 숲",
        ADDR1: "부산광역시 기장군 철마면 미동길 37-1",
        CNTCT_TEL: "051-721-9183",
        HOMEPAGE_URL: "http://ahopsan.com",
        TRFC_INFO:
          "도시철도 1호선 노포역 → 2-3 마을버스 환승 → 미동마을 하차\n주차 아홉산숲 주차장",
        USAGE_DAY: "",
        HLDY_INFO: "매주 월요일",
        USAGE_DAY_WEEK_AND_TIME: "평일, 주말 09:00~18:00 (입장마감 16시30분)",
        USAGE_AMOUNT: "5,000원 (5세부터)",
        MIDDLE_SIZE_RM1: "",
        MAIN_IMG_NORMAL:
          "https://www.visitbusan.net/uploadImgs/files/cntnts/20191222185645736_ttiel",
        MAIN_IMG_THUMB:
      ...
      },
      {
        ...
        PLACE: "해동용궁사",
        TITLE: "기장에 가면 해동용궁사",
        SUBTITLE: "바다전망 성지, 해동용궁사를 가다",
        ADDR1: "부산광역시 기장군 기장읍 용궁길 86",
        CNTCT_TEL: "051-722-7744 ",
        HOMEPAGE_URL: "http://www.yongkungsa.or.kr",
        TRFC_INFO:
          "도시철도 2호선 해운대역 7번 출구 → 181, 100, 해운대 9 버스 환승 → 해동용궁사 하차\n동해선 오시리아역 1번 출구 → 오시리아역 버스정류장 139 버스 환승 → 해동용궁사 하차\n부산시티투어버스 부산역(레드라인) → 해운대해수욕장 버스 환승(블루라인 ) → 해동용궁사 하차\n주차 해동용궁사 주차장 (유료)",
        USAGE_DAY: "",
        HLDY_INFO: "",
        USAGE_DAY_WEEK_AND_TIME: "매일, 05:00 ~ 일몰 시까지",
        USAGE_AMOUNT: "",
        MIDDLE_SIZE_RM1: "장애인 화장실",
        MAIN_IMG_NORMAL:
      ...
      },
      {
        ...
        LNG: 129.26451,
        PLACE: "임랑해수욕장 ",
        TITLE: "나만 알고 싶은 해수욕장, 임랑해수욕장",
        SUBTITLE: "하얀 백사장에 어우러진 은색 달빛",
        ADDR1: "부산광역시 기장군 장안읍 임랑리",
        CNTCT_TEL: "051-709-5448",
        HOMEPAGE_URL: "",
        TRFC_INFO:
          "도시철도 2호선 해운대역 → 180 버스 환승 → 임랑삼거리 하차\n버스 37, 180, 188 임랑삼거리 하차\n마을버스 기장군9, 기장군3 임랑삼거리 하차",
        USAGE_DAY: "해수욕장 개장기간 : 매년 7월 1일 ~ 8월 31일",
        HLDY_INFO: "",
        USAGE_DAY_WEEK_AND_TIME: "09:00~18:00 (개장 중 입수가능 시간)",
        USAGE_AMOUNT: "무료",
        MIDDLE_SIZE_RM1: "휠체어 진입 가능, 장애인 주차장, 장애인 화장실",
        MAIN_IMG_NORMAL:
          "https://www.visitbusan.net/uploadImgs/files/cntnts/20191224093809621_ttiel",
        MAIN_IMG_THUMB:
      ...
      },
      {
        ...
        LNG: 129.2336,
        PLACE: "일광해수욕장",
        TITLE: "부산바다의 과거와 현재, 일광해수욕장",
        SUBTITLE: "트렌디한 해양스포츠부터 옛 풍경까지",
        ADDR1: "부산광역시 기장군 일광면 삼성3길 17 ",
        CNTCT_TEL: "051-709-5446",
        HOMEPAGE_URL: "",
        TRFC_INFO:
          "도시철도 2호선 해운대역 → 1006, 180번 버스환승 → 일광해수욕장 입구 하차\n버스 188, 180, 1006 일광해수욕장 입구 하차\n마을버스 기장군2, 기장군8-1, 기장군9, 기장군3, 기장군8 일광해수욕장 입구 하차",
        USAGE_DAY: "개장기간 : 매년 7월 1일 ~ 8월 31일",
        HLDY_INFO: "",
        USAGE_DAY_WEEK_AND_TIME: "09:00~18:00 (개장 중 입수가능 시간)",
        USAGE_AMOUNT: "무료",
        MIDDLE_SIZE_RM1: "점자블록, 장애인 주차장, 장애인 화장실",
        MAIN_IMG_NORMAL:
          "https://www.visitbusan.net/uploadImgs/files/cntnts/20191225143353231_ttiel",
        MAIN_IMG_THUMB:
          "https://www.visitbusan.net/uploadImgs/files/cntnts/20191225143353231_thumbL",
        ITEMCNTNTS:
